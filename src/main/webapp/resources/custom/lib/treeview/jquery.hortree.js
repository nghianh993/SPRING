...
;(function ($, window, document, undefined) {
    ...
    function branchList(elem) {
        ...
        if (elem.tooltip && elem.tooltip.toString().trim() !== '') {
            ...
            html.push('<div class="hortree-label">' + elem.description);
            html.push('<span class"ad-form-fn-func editOrganization" data-id="' +elem.id + '" title="Cập nhật thông tin" style="padding-left: 5px; font-size: 16px; cursor: pointer;"><i class="fa fa-pencil"></i></span>');
            html.push('<span class"ad-form-fn-func deleteOrganization" data-id="' +elem.id + '" title="Xóa thông tin" style="padding-left: 5px; font-size: 16px; cursor: pointer;"><i class="fa fa-trash-o"></i></span>');
            html.push('</div>');
        }
